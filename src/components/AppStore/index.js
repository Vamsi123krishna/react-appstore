...
class AppStore extends Component {
  ...
  render() {
    ...
    const filterApps = this.getFilteredApps()
    const searchFilterApp = appsList.filter(eachAppDetail =>
      eachAppDetail.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
